...
:math:`u{{^{\prime}}}=A(t)u`, kallast *núllrúm :hover:`núllrúm`
...
:math:`A(t)=(a_{jk}(t))_{j,k=1}^ m`. Mengi allra lausna myndar
...
Ef :math:`A=TBT^{-1}`, :math:`f(z)=\sum_{n=0}^\infty a_nz^n` er fágað
