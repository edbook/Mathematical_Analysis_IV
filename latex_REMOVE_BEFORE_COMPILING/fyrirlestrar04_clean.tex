...
\subsubsection{Setning}\tx{Laurent :hover:`Laurent-setningin` :hover:`setning!Laurent`}
...
\subsubsection{Setning}\tx{Riemann :hover:`Riemann-setningin` :hover:`setning!Riemann`}
...
\subsubsection{Setning}\tx{Casorati-Weierstrass :hover:`Casorati-Weierstrass-setningin`
 :hover:`setning!Casorati-Weierstrass`}
...
\subsubsection{Setning}\tx{Leifasetningin :hover:`leifasetningin`}  
