...
.. math::
   ...
   {{\cal L}}f(s)=\int_0\sp \infty e\sp{-st}f(t)\, dt.
...
.. math::
   ...
   |f(t)|\leq Me\sp{c t}, \qquad t\in {{\mathbb  R}}_+.
...
:math:`s\in {{\mathbb  C}}` með :math:`{{\operatorname{Re\, }}}s
>c`. Við fáum að auki vaxtartakmarkanir á :math:`{{\cal L}}f`,

.. math::

   |{{\cal L}}f(s) |\leq \int_0\sp\infty e\sp{-{{\operatorname{Re\, }}}st} Me\sp{c t} \, dt =
...
heildanlegt á sérhverju bili :math:`[0,b]` og uppfyllir (:ref:‘7.1.2‘).
...
:math:`f\in C\sp
1({{\mathbb  R}}_+)` af veldisvísisgerð og reikna út heildið

.. math::

   \begin{aligned}
   \int_0\sp b e\sp{-st}f{{\sp{\prime}}}(t)\, dt &=
   \left[e\sp{-st}f(t)\right]_0\sp b+
   \int_0\sp b se\sp{-st}f(t)\, dt \\
   &=
   s\int_0\sp b e\sp{-st}f(t)\, dt -f(0)+e\sp{-sb}f(b).\end{aligned}
...
.. math::
   ...
   {{\cal L}}\{f{{\sp{\prime}}}\}(s)=s{{\cal L}}\{f\}(s)-f(0).


   .. _7.3.1:

 Ef við gerum ráð fyrir að :math:`f\in C^2({{\mathbb  R}}_+)` og að bæði
:math:`f` og :math:`f{{\sp{\prime}}}` séu af veldisvísisgerð, þá fáum
við með því að beita þessari formúlu tvisvar að

.. math::

   {{\cal L}}\{f{{\sp{\prime\prime}}}\}(s)=s{{\cal L}}\{f{{\sp{\prime}}}\}(s)-f{{\sp{\prime}}}(0)=s\sp 2{{\cal L}}\{f\}(s)
   -sf(0)-f{{\sp{\prime}}}(0),
...
Ef :math:`f\in C\sp m({{\mathbb  R}}_+)` og
:math:`f, f{{\sp{\prime}}}, f{{\sp{\prime\prime}}},
\dots, f\sp{(m-1)}`, eru af veldisvísisgerð, þá er
:math:`{{\cal L}}\{f\sp{(m)}\}(s)` skilgreint fyrir öll
...
.. math::
   ...
   {{\cal L}}\{f\sp{(m)}\}(s)=s\sp
   m{{\cal L}}\{f\}(s)-s\sp{m-1}f(0)-\cdots-sf\sp{(m-2)}(0)-f\sp{(m-1)}(0).
...
.. math::
   ...
   u(a)=b_0, u{{\sp{\prime}}}(a)=b_1,\  \dots,  \  u^{(m-1)}(a)=b_{m-1}.
...
.. math::
   ...
   {{\cal L}}\{u_p{{\sp{\prime}}}\}(s)=sU_p(s), \quad 
   {{\cal L}}\{u_p{{\sp{\prime\prime}}}\}(s)=s^2U_p(s),\dots,
...
.. math::
   ...
   P(D)g=0, \  g(0)=g{{\sp{\prime}}}(0)=\cdots=g^{(m-2)}(0)=0, \ 
   g^{(m-1)}(0)=\dfrac 1{a_m}.
...
.. math::
   ...
   \begin{aligned}
   {{\cal L}}\{g{{\sp{\prime}}}\}(s) &= s{{\cal L}}\{g\}(s)-g(0)=sU(s),\\
   {{\cal L}}\{g{{\sp{\prime\prime}}}\}(s) &= s^2{{\cal L}}\{g\}(s)-sg(0)-g{{\sp{\prime}}}(0)\\
   &=s^2U(s),\\
